...
$layout_info->layout = "index";
$layout_info->type = "";
$layout_info->path = "./layouts/index/";
$layout_info->title = "XE 연습 가자";
$layout_info->description = "
        XE 연습하는 페이지
        제작 : Seonjoo
    ";
$layout_info->version = "1.7";
$layout_info->date = "20180325";
...
$layout_info->author[0]->name = "SEONJOO";
$layout_info->author[0]->email_address = "seonjoo2030s@hanmail.net";
...
$layout_info->extra_var->layout_view_type = new stdClass;
$layout_info->extra_var->layout_view_type->group = "";
$layout_info->extra_var->layout_view_type->title = "레이아웃 형태";
$layout_info->extra_var->layout_view_type->type = "select";
$layout_info->extra_var->layout_view_type->value = $vars->layout_view_type;
$layout_info->extra_var->layout_view_type->description = "원하시는 레이아웃의 보기 형태를 선택해 주세요";
$layout_info->extra_var->layout_view_type->options = array();
$layout_info->extra_var->layout_view_type->options["main"] = new stdClass;
$layout_info->extra_var->layout_view_type->options["main"]->val = "메인 레이아웃 형태로 사용";
$layout_info->extra_var->layout_view_type->options["sub"] = new stdClass;
$layout_info->extra_var->layout_view_type->options["sub"]->val = "서브 레이아웃 형태로 사용";
