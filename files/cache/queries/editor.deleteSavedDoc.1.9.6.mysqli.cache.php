...
${'certify_key4_argument'} = new ConditionArgument('certify_key', $args->certify_key, 'equal');
${'certify_key4_argument'}->createConditionValue();
if(!${'certify_key4_argument'}->isValid()) return ${'certify_key4_argument'}->getErrorMessage();
} else
${'certify_key4_argument'} = NULL;if(${'certify_key4_argument'} !== null) ${'certify_key4_argument'}->setColumnType('varchar');
...
,new ConditionWithArgument('`certify_key`',$certify_key4_argument,"equal", 'and')))
));
