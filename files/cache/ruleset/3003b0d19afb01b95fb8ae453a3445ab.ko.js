...
v.cast('ADD_FILTER',['insertMember', {'email_address':{required:true,rule:'email'},'password':{'if':[{test:'$act == \'procMemberInsert\'', attr:'required', value:'true'},{test:'$act == \'procMemberInsert\'', attr:'length', value:'4:60'}]},'password2':{'if':[{test:'$act == \'procMemberInsert\'', attr:'required', value:'true'},{test:'$act == \'procMemberInsert\'', attr:'equalto', value:'password'}]},'nick_name':{required:true,minlength:'2',maxlength:'20'},'find_account_question':{'if':[{test:'$modify_find_account_answer', attr:'required', value:'true'}]},'find_account_answer':{maxlength:'250','if':[{test:'$modify_find_account_answer', attr:'required', value:'true'}]}}]);
