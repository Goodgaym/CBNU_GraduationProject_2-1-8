<?php if(!defined("__XE__"))exit;?>                    <?php if($__Context->document_list&&count($__Context->document_list))foreach($__Context->document_list as $__Context->document){ ?>
                        <h2 class="postTitle"><a href="<?php echo getUrl('','document_srl',$__Context->document->document_srl,'cpage','') ?>"><?php echo $__Context->document->getTitle() ?></a></h2>
                        <dl class="postMeta">
                            <dt>in</dt>
                            <dd><a href="<?php echo getUrl('document_srl','','entry','','category',$__Context->document->get('category_srl')) ?>"><?php echo $__Context->category_list[$__Context->document->get('category_srl')]->title ?></a></dd>
                            <dt>on</dt>
                            <dd><?php echo $__Context->document->getRegdate("Y.m.d") ?></dd>
                            <dt>at</dt>
                            <dd><?php echo $__Context->document->getRegdate("H:i") ?></dd>
                            <dt>by</dt>
                            <dd><span class="member_<?php echo $__Context->document->get('member_srl') ?>"><?php echo $__Context->document->getNickName() ?></span></dd>
                            <dd><a href="<?php echo getSiteUrl($__Context->textyle->domain,'document_srl',$__Context->document->document_srl,'act','dispTextyleToolPostManageWrite') ?>" class="editPost">Edit</a></dd>
                        </dl>
                        ...
                        <dl class="usedTag">
                            <dt><img src="/modules/textyle/skins/happyLetter/img/iconTag.gif" width="21" height="12" alt="Tag" /></dt>
                            <dd>
                        ...
                        <div class="pagination paginationPost">
                            <?php if($__Context->prev_document){ ?>
                                <a href="<?php echo getUrl('','document_srl',$__Context->prev_document->document_srl) ?>" class="prev"><?php echo $__Context->prev_document->getTitle() ?><span class="date"><?php echo $__Context->prev_document->getRegdate("Y.m.d") ?></span></a>
                            <?php } ?>
                            <?php if($__Context->next_document){ ?>
                                <a href="<?php echo getUrl('','document_srl',$__Context->next_document->document_srl) ?>" class="next"><?php echo $__Context->next_document->getTitle() ?><span class="date"><?php echo $__Context->next_document->getRegdate("Y.m.d") ?></span></a>
                            <?php } ?>
                        </div>
                        <?php } ?>
                        ...
                        <div class="feedback trackback">
                            <h3 class="feedbackTitle"><em><?php echo $__Context->document->getTrackbackCount() ?></em> Trackbacks</h3>
                            ...
                            <ol class="feedbackOrder">
                                ...
                                <li class="item">
                                    ...
                                    <div class="meta">
                                        <h4 class="author">
											<?php echo $__Context->val->blog_name ?>
										</h4>
                        ...
                        <div class="feedback reply">
                            <h3 class="feedbackTitle"><em><?php echo $__Context->document->getCommentCount() ?></em> Comments</h3>
                                ...
                                <li class="item<?php if($__Context->comment->get('depth')){ ?> indent indent<?php echo $__Context->comment->get('depth');
                                    ...
                                    <div class="meta">
                                        <div class="thumb">
                                            ...
                                            <?php }else{ ?>
                                                <img src="/modules/textyle/skins/happyLetter/img/iconAuthorNoImage.gif" width="39" height="39" alt="Author" />
                                            <?php } ?>
                                        </div>
                                        <h4 class="author">
                        ...
                        <div class="pagination paginationNum">
                            <?php if($__Context->document->comment_page_navigation->cur_page>1){ ?><a href="<?php echo getUrl('cpage',$__Context->document->comment_page_navigation->cur_page-1) ?>#comment" class="prev"><span>Prev</span></a><?php } ?>
                            <?php while($__Context->page_no = $__Context->document->comment_page_navigation->getNextPage()){ ?>
                                ...
                                <?php } ?>
                            <?php } ?>
                            <?php if($__Context->document->comment_page_navigation->cur_page<$__Context->document->comment_page_navigation->total_page){ ?><a href="<?php echo getUrl('cpage',$__Context->document->comment_page_navigation->cur_page+1) ?>#comment" class="next"><span>Next</span></a><?php } ?>
                        </div>
                        <?php } ?>
                        <div class="replyForm">
                            ...
                            <fieldset>
                                <form method="post" onsubmit="return insertCommentItem(this, insert_comment)" action=""><input type="hidden" name="error_return_url" value="<?php echo htmlspecialchars(getRequestUriByServerEnviroment(), ENT_COMPAT | ENT_HTML401, 'UTF-8', false) ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
									...
									<div class="replyFooter">
										...
										<span class="inputSubmit"><input name="" type="submit" value="SUBMIT" /></span>
									</div>
                                </form>
                            </fieldset>
                            <?php }else{ ?>
