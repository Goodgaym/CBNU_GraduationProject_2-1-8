<?php if(!defined("__XE__"))exit;?>                    <?php if($__Context->document_list&&count($__Context->document_list))foreach($__Context->document_list as $__Context->document){ ?>
                        ...
                        <dl class="usedTag">
                            <dt><img src="/files/attach/textyle/223/img/iconTag.gif" width="21" height="12" alt="Tag" /></dt>
                            <dd>
                                ...
                                <li class="item<?php if($__Context->comment->get('depth')){ ?> indent indent<?php echo $__Context->comment->get('depth');
                                    ...
                                    <div class="meta">
                                        <div class="thumb">
                                            ...
                                            <?php }else{ ?>
                                                <img src="/files/attach/textyle/223/img/iconAuthorNoImage.gif" width="39" height="39" alt="Author" />
                                            <?php } ?>
                                        </div>
                                        <h4 class="author">
