<?php if(!defined("__XE__"))exit;?><ul class="widgetGalleryA" style="width:<?php echo $__Context->widget_info->cols_list_count*($__Context->widget_info->thumbnail_width+28) ?>px;">
